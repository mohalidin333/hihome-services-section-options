...
export const services: ServiceItem[] = [
  {
    ...
    imageBg: "linear-gradient(135deg, #1e3a52 0%, #2d5f82 55%, #3d7a9e 100%)",
    icon: "home",
  ...
  },
  {
    ...
    imageBg: "linear-gradient(135deg, #12243a 0%, #1c3650 55%, #274a68 100%)",
    icon: "tag",
    iconBg: "rgba(255, 255, 255, 0.12)",
    iconColor: "rgba(255, 255, 255, 0.88)",
  },
  {
    ...
    imageBg: "linear-gradient(135deg, #0c1928 0%, #142234 55%, #1d3248 100%)",
    icon: "building",
    iconBg: "rgba(255, 255, 255, 0.12)",
    iconColor: "rgba(255, 255, 255, 0.88)",
  },
  {
    ...
    imageBg: "linear-gradient(135deg, #182d3e 0%, #1f3a50 55%, #2a4e68 100%)",
    icon: "chart",
    iconBg: "rgba(255, 255, 255, 0.12)",
    iconColor: "rgba(255, 255, 255, 0.88)",
  },
